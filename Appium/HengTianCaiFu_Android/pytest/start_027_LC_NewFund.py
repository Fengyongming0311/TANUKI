...
class Test_LC_NewFund:

    @allure.feature('用例名称:登录恒天财富账号')
    def test_LC_NewFund_001Login(self):
        """
        前置条件：
        安装恒天财富APP
        测试步骤：
    ...
    def test_LC_NewFund_002IntoProduct_tv(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_NewFund_003NewFund(self):
        """
        """
        driver = Driver.driver
    ...
    #@pytest.mark.skip(reason="不执行这条用例")
    @allure.feature('用例名称:新发基金→查看新发基金内容')
    def test_LC_NewFund_004ChickNewFund(self):
        """
        """
        driver = Driver.driver
        TestResult = NewFund.ClickFund(driver)
    ...
    def test_LC_NewFund_005PreferredProducts(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_NewFund_006GMTuiJian(self):
        """
        """
        driver = Driver.driver
...
if __name__ == "__main__":
    ...
    if int(ENV) == 1:
        ...
        pytest.main(['start_027_LC_NewFund.py', "-s", "-v"])
