...
class Test_LC_DingTouPaiHang:

    #@allure.feature('用例名称:登录恒天财富账号')
    def test_LC_DingTouPaiHang_001Login(self):
        """
        前置条件：
        安装恒天财富APP
        测试步骤：
    ...
    def test_LC_DingTouPaiHang_002IntoProduct_tv(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_003Into_JiJinPaiHang(self):
        """
        """
        driver = Driver.driver
        TestResult = JiJinPaiHang.Into_JiJinPaiHang(driver)
        JiJinPaiHang.SwitchDingTou(driver)
        assert TestResult == True
    ...
    def test_LC_DingTouPaiHang_004MixFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_005GuPiaoFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_006ZQFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_007HBFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_008HBFund(self):
        """
        """
        driver = Driver.driver
        ZixuanJijin.Switch_Category(driver,"货币")
    ...
    def test_LC_DingTouPaiHang_009QDIIFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_010FenJiFund(self):
        """
        """
        driver = Driver.driver
    ...
    def test_LC_DingTouPaiHang_011FOFFund(self):
        """
        """
        driver = Driver.driver
...
if __name__ == "__main__":
    ...
    if int(ENV) == 1:
        ...
        pytest.main(['start_026_LC_DingTouPaiHang.py', "-s", "-v"])
