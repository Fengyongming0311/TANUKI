...
class Into_WoDe:
    def Into_WoDe(driver):
        ...
        try:
            ...
            dibu = driver.find_elements_by_id("com.tencent.mm:id/civ")
            for i in dibu:
            ...
            shidi = driver.find_elements_by_id("com.tencent.mm:id/e_v")
            for i in shidi:
                if i.text == "实地打造师":
                    i.click()
                    break
            ...
            # print("测试点击网页")
            time.sleep(3)
            driver.find_element_by_xpath("//*[@id=\"tabBar\"]/wx-view/wx-view[3]").click()
            #                             //*[@id="tabBar"]/wx-view/wx-view[3]
            #点击我的按钮进入我的页面
